...
function getCpuChoice() {
  ...
  function win(userChoice, cpuChoice) {
    ...
    result.innerHTML = `<h1 class="text-win">You win!</h1> <p>AI choose <strong>${cpuChoice}</strong></p>`;
  ...
  function lose(userChoice, cpuChoice){
    ...
    userScore_span.innerHTML = userScore;
    cpuScore_span.innerHTML = cpuScore;
    result.innerHTML = `<h1 class="text-lose">You lost</h1> <p> AI choose <strong>${cpuChoice}</strong></p>`; 
    modal.style.display = 'block'
  }
